...
public class MopUpActionState implements CurrentActionState {
    public MopUpActionState(AbstractGameAction action) {}

    @Override
    public AbstractGameAction loadCurrentAction() {
        MopUpAction result = new MopUpAction();
    ...
    @SpirePatch(
            clz = MopUpAction.class,
            paramtypez = {},
            method = "update"
    )
    public static class HalfDoneActionPatch {
        public static void Postfix(MopUpAction _instance) {
